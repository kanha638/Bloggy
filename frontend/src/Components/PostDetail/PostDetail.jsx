    ...
    <div className="PostDetail">
      <div className="postWrapper">
        <img src={image} alt="PostImage" className="postimg" />
          ...
          <h1 className="Posttitle">Lorem, ipsum dolor sit amet consectetur adipisicing elit
        ...
        <p className="postcontent">
          ...
          Perspiciatis ullam accusamus numquam aliquam,
          exercitationem debitis laudantium modi architecto similique nostrum molestiae
          id molestias quaerat optio! Quam aut voluptatibus nam tempora.
           Lorem ipsum dolor sit, amet consectetur adipisicing elit.
          Perspiciatis ullam accusamus numquam aliquam,
          exercitationem debitis laudantium modi architecto similique nostrum molestiae
          id molestias quaerat optio! Quam aut voluptatibus nam tempora.
