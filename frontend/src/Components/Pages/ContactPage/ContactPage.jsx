        ...
        <>
            <div className="contactpage">
                ...
                <div className="contactus">
                    <div className="contactbar1">We Are Here To Help You For Any Kind Of Technical Issue or Information Regarding Our Website</div>
                    <div className="contactbar2">
                        <div><h1 className="cb2">ContactUs</h1></div>
                    ...
                    <div className="contactinput">
                        <form className="adversary">
                            <div className="collectissue">
                                ...
                                <input className="inputissue" type="text" placeholder="issue topic"></input>
                            </div>
                            <div className="collectissue">
                                <label>Full Name</label>
                                <input className="inputissue" type="text" placeholder="e.g.Aadi Adwaani"></input>
                            </div>
                            <div className="collectissue">
                                <label>Email address if any</label>
                                <input className="inputissue" type="text" placeholder="e.g. jay@gmail.com"></input>
                            </div>
                            <div className="collectissue">
                                <label>Describe Here</label>
                                <input className="inputissue detail" type="text" placeholder="Write your issue"></input>
                            </div>
